...
今天有朋友问了下关于Comparator和Comparable的问题，估计很多人都曾经有过对这个问题的疑问吧，今天就把这个说明下。本篇文章译自[Java Sorting: Comparator vs Comparable Tutorial](http://www.digizol.com/2008/07/java-sorting-comparator-vs-comparable.html)。接下来是正文：

Java Comparators and Comparables?他们是什么？我们为什么要用他们？这是我们的读者反馈的问题中的其中一个。这篇文章会讨论详细java.util.Comparator和java.lang.Comparable，并且会附上部分代码做更详细的阐述。
...
基本都见名知义，它们在Java中被用于objects的比较。Java objects使用它们可以根据一个预先定义的顺序去排序。

接下来我们会解释其中的两个概念。

## Comparable

一个comparable对象能够对比自己和另外的对象。这个类本身必须实现java.lang.Comparable的接口，为了能够对比其他示例。
...
这个方法用于一个当前对象与o1对象对比，返回int值，分别的意思是：
...
这个方法用于一个o1与o2对象对比，返回int值，分别的意思是：
